...
ProblemSetModel problemSetModelFromJson(String str) => ProblemSetModel.fromJson(json.decode(str));

String problemSetModelToJson(ProblemSetModel data) => json.encode(data.toJson());
...
class ProblemSetModel {
    ...
    factory ProblemSetModel.fromJson(Map<String, dynamic> json) => ProblemSetModel(
...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        problemsetQuestionList: ProblemsetQuestionList.fromJson(json["problemsetQuestionList"]),
    );
...
class ProblemsetQuestionList {
    ...
    factory ProblemsetQuestionList.fromJson(Map<String, dynamic> json) => ProblemsetQuestionList(
        total: json["total"],
...
class Question {
    ...
    factory Question.fromJson(Map<String, dynamic> json) => Question(
        ...
        topicTags: List<TopicTag>.from(json["topicTags"].map((x) => TopicTag.fromJson(x))),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "title": title,
        "titleSlug": titleSlug,
        "topicTags": List<dynamic>.from(topicTags.map((x) => x.toJson())),
    };
}
